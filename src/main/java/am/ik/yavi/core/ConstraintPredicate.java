...
public class ConstraintPredicate<V> {
    ...
    private ConstraintPredicate(Predicate<V> predicate, ViolationMessage violationMessage,
                                Supplier<Map<String, Object>> args, NullAs nullAs) {
    ...
    private ConstraintPredicate(Predicate<V> predicate, String messageKey,
                                String defaultMessageFormat, Supplier<Map<String, Object>> args, NullAs nullAs) {
    ...
    public static <V> ConstraintPredicate<V> of(Predicate<V> predicate, ViolationMessage violationMessage, Supplier<Map<String, Object>> args, NullAs nullAs) {
    ...
    public static <V> ConstraintPredicate<V> withViolatedValue(
            ...
            ViolationMessage violationMessage, Supplier<Map<String, Object>> args, NullAs nullAs) {
