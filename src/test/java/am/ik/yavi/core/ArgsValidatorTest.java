...
public class ArgsValidatorTest {
    ...
    public void argsByKeyValueToConstraint() {
        ...
        Validator<User> validator = ValidatorBuilder.<User>of()
                ...
                ._string(User::getEmail, "email", CharSequenceConstraint::email).args("email_key", "email_value")
                .build();
    ...
    public void argsByMultipleKeyValueToConstraint() {
        ...
        Validator<User> validator = ValidatorBuilder.<User>of()
                ...
                ._string(User::getEmail, "email", CharSequenceConstraint::email)
    ...
    public void argsByMapToConstraint() {
        ...
        Validator<User> validator = ValidatorBuilder.<User>of()
                ...
                ._string(User::getEmail, "email", CharSequenceConstraint::email).args(email_args)
                .build();
